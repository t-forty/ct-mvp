...
function Job(props) {
  const params = useParams()
    const API_URL = 'https://api.careeronestop.org/v1/jobsearch/'+API_ID+'/'+params.trade+'/'+props.zip+'/40/0/0/0/40/60?source=NLx&showFilters=false'                                                                      
  ...
  <div id="jobs-container">
    ...
    >
        ...
        {Data.data.Jobcount < 1 && <span>No jobs found in this area. Change location and try again</span>}
        </> }
    </Box>
  </div>
  );
